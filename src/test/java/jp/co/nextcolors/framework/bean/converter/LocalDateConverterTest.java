...
/**
 * {@link LocalDateConverter} のテストです。
 *
 * @author hamana
 */
class LocalDateConverterTest {
    ...
    /**
     * {@link LocalDateConverter#getDateTime(OffsetDateTime)} のテストです。
     */
    @Test
    void testGetDateTime() {
        final OffsetDateTime offsetDateTime = localDates().get().atStartOfDay(converter.zone).toOffsetDateTime();

        assertThat(converter.getDateTime(offsetDateTime)).isEqualTo(offsetDateTime.toLocalDate());
