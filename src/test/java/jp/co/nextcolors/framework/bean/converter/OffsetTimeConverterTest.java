...
/**
 * {@link OffsetTimeConverter} のテストです。
 *
 * @author hamana
 */
class OffsetTimeConverterTest {
    ...
    /**
     * {@link OffsetTimeConverter#getDateTime(OffsetDateTime)} のテストです。
     */
    @Test
    void testGetDateTime() {
        final OffsetDateTime offsetDateTime = localDates().get().atStartOfDay(converter.zone).toOffsetDateTime();

        assertThat(converter.getDateTime(offsetDateTime)).isEqualTo(offsetDateTime.toOffsetTime());
