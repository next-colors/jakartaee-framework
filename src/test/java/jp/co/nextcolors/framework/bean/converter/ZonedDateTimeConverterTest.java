...
/**
 * {@link ZonedDateTimeConverter} のテストです。
 *
 * @author hamana
 */
class ZonedDateTimeConverterTest {
    ...
    /**
     * {@link ZonedDateTimeConverter#getDateTime(OffsetDateTime)} のテストです。
     */
    @Test
    void testGetDateTime() {
        final OffsetDateTime offsetDateTime = localDates().get().atStartOfDay(converter.zone).toOffsetDateTime();

        assertThat(converter.getDateTime(offsetDateTime)).isEqualTo(offsetDateTime.toZonedDateTime());
