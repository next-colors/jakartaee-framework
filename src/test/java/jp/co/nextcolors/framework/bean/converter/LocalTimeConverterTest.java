...
/**
 * {@link LocalTimeConverter} のテストです。
 *
 * @author hamana
 */
class LocalTimeConverterTest {
    ...
    /**
     * {@link LocalTimeConverter#getDateTime(OffsetDateTime)} のテストです。
     */
    @Test
    void testGetDateTime() {
        final OffsetDateTime offsetDateTime = localDates().get().atStartOfDay(converter.zone).toOffsetDateTime();

        assertThat(converter.getDateTime(offsetDateTime)).isEqualTo(offsetDateTime.toLocalTime());
