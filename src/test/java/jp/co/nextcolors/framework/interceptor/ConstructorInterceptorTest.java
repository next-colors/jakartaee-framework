...
/**
 * {@link ConstructorInterceptor} のテストです。
 *
 * @author hamana
 */
@ExtendWith(MockitoExtension.class)
class ConstructorInterceptorTest {
    private final ConstructorInterceptor interceptor = mock(ConstructorInterceptor.class, Mockito.CALLS_REAL_METHODS);

    @Mock
    private InvocationContext context;

    /**
     * {@link ConstructorInterceptor#invoke(InvocationContext)} のテストです。
     */
